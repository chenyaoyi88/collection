declare namespace wx {
  ...
  interface ShareMessage extends BaseOptions {
    ...
    success?(res: { shareTickets: string[] }): void;
  }
...
declare namespace wx {
  interface RecordManager {
    ...
    ): void; // 已录制完指定帧大小的文件，会回调录音分片结果数据。如果设置了 frameSize ，则会回调此事件
...
declare namespace wx {
  function pageScrollTo(options: {
    ...
    duration?: number; // 滚动到页面的目标位置（单位px）
  }): void;
}
...
declare namespace wx {
  interface GetExtConfigOption extends BaseOptions {
    success?(ret: { errMsg: string; extConfig?: any }): void;
  }
  /**
   * 获取第三方平台自定义的数据字段。
   */
