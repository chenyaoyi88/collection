...
const api = {
    ...
    // 绑定邀请人手机号码
    bind: requestHost + '/api/v1/decInviter/bind',
    // 获取邀请人红包领取列表
    findDecInviterRedpackList: requestHost + '/api/v1/findDecInviterRedpackList',
    // 领取邀请人红包
    receiveDecInviterRedpack: requestHost + '/api/v1/receiveDecInviterRedpack'
};
