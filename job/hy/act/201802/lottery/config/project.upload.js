...
const entireBasePath = './public_html/act/2018/02/' + appConfig.appName;
// const entireBasePath = './pub/ghb-web/act/2018/03/' + appConfig.appName;
// const entireBasePath = `./pub/ghb-web/act/${appConfig.onlineTime.year}/${appConfig.onlineTime.month}/${appConfig.appName}`;
